...
document.getElementById('start_current').innerText = url.searchParams.get('start_current');
document.getElementById('consumptionCold').innerText = url.searchParams.get('consumptionCold');
document.getElementById('consumptionHeat').innerText = url.searchParams.get('consumptionHeat');
document.getElementById('operatingHeat').innerText = url.searchParams.get('operatingHeat');
document.getElementById('operatingCold').innerText = url.searchParams.get('operatingCold');
document.getElementById('refrigerant').innerText = url.searchParams.get('refrigerant');
document.getElementById('psig_h').innerText = url.searchParams.get('psig_h');
document.getElementById('psig_l').innerText = url.searchParams.get('psig_l');
document.getElementById('cspfNo').innerText = url.searchParams.get('cspfNo');
document.getElementById('air_volume').innerHTML = airVolume;
document.getElementById('outdoor_kg').innerText = url.searchParams.get('air_kg');
