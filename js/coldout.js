...
document.getElementById('energy_consumption').innerText = url.searchParams.get('energy_consumption');
document.getElementById('operating_current').innerText = url.searchParams.get('operating_current');
document.getElementById('psig_h').innerText = url.searchParams.get('psig_h');
document.getElementById('psig_h').innerText = url.searchParams.get('psig_h');
document.getElementById('cspp').innerText = url.searchParams.get('outCsPp');
