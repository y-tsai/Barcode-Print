$(document).ready(() => {
  ...
  $("#operating_currentText").get(0).textContent = $("#operating_current").text(); 
  $("#energy_consumptionText").get(0).textContent = $("#energy_consumption").text(); 
  $("#csppNoText").get(0).textContent = $("#csppNo").text(); 
