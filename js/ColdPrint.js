...
function getTableData() {
  ...
  document.getElementById("product_name").innerText = url.searchParams.get(
    "product_name"
  );
  document.getElementById("air_type").innerText = url.searchParams.get(
    "air_type"
  );
  document.getElementById("power_phase").innerText = url.searchParams.get(
    "power_phase"
  );
  document.getElementById("power_volt").innerText = url.searchParams.get(
    "power_volt"
  );
  document.getElementById("capacity_cool").innerText = url.searchParams.get(
    "capacity_cool"
  );
  ...
  document.getElementById("company_address").innerText = url.searchParams.get(
    "company_address"
  );
  document.getElementById("case_no").innerText = url.searchParams.get(
    "case_no"
  );
