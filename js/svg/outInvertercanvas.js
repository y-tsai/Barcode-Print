$(document).ready(() => {
  ...
  $("#capacity_coldText").get(0).textContent = "冷 " +$("#capacity_cold").text();
  $("#capacity_HeatText").get(0).textContent = "冷 " +$("#capacity_Heat").text();
  $("#start_currentText").get(0).textContent = $("#start_current").text(); 
  $("#operatingColdText").get(0).textContent = "冷 " +$("#operatingCold").text(); 
  $("#operatingHeatText").get(0).textContent = "冷 " +$("#operatingHeat").text(); 
  $("#consumptionColdText").get(0).textContent = "冷 " +$("#consumptionCold").text(); 
  $("#consumptionHeatText").get(0).textContent = "冷 " +$("#consumptionHeat").text(); 
  $("#centerCapacityColdText").get(0).textContent = "冷 " +$("#centerCapacityCold").text(); 
  $("#centerConsumptionColdText").get(0).textContent = $("#centerConsumptionCold").text(); 
