...
document.getElementById('centerCapacityCold').innerText = url.searchParams.get('centerCapacityCold');
document.getElementById('centerConsumptionCold').innerText = url.searchParams.get('centerConsumptionCold');
